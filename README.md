...
CITE Application is a single web page you can open in a browser. Precompiled versions are available in the [compiled-one-file-app directory](compiled-one-file-app), and named `cite-VERSION.html`.
